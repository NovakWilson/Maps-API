...
def maps_fourth_part(cords, scale):
    ...
    while running:
            ...
            if event.type == pygame.QUIT:
                ...
                if active:
                    if event.key == pygame.K_RETURN:
                        ...
                        #toponym_postal_index = toponym_address["postal_code"]
                        #toponym_address = '{} {}'.format(toponym_address, toponym_postal_index)
        ...
        txt_address = font.render(toponym_address, True, (0, 0, 0))
        pygame.draw.rect(screen, color, (400, 10, 200, 25))
        pygame.draw.rect(screen, color_inactive, (500, 40, 50, 25))
        pygame.draw.rect(screen, color_inactive, (50, 420, 500, 25))
        screen.blit(txt_surface, (400, 10))
        screen.blit(txt_delete, (510, 40))
        screen.blit(txt_address, (50, 420))
        pygame.display.flip()
        os.remove(map_file)
